...
#This code takes as input the adaptable interaction matrices identified by oscillatory training
#and runs molecular dynamics with that matrix

run = int(sys.argv[1])

folder = 'adaptable_configurations3_c%d' % run
...
Cd = np.load('../data_folder/oscillating_training_C1dist.npy')
C = Cd[run]
