...
#If two such matrices are recorded in consecutive periods (and there are only 2 periods here)
#then we add them to the ensemble in the storage lists.
success = 0
for run in runs:
