...
folder = 'singletarget_training_c%d' % run
...
#Just two episodes, one for the spiral and the other for the anti-spiral
num_episodes = 2

#each episode consists of 25 training calls to CMA-ES
period = 25
